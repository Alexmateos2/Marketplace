      ...
      <main className="flex-1">
        ...
        <section className="py-12 sm:py-16 text-center">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 p-4 sm:p-2 perspective-1000">
              <Card
        ...
        {/* Stay Updated */}
        <section className="bg-surface-light dark:bg-surface-dark w-full xl:w-3/5 mx-auto rounded-lg py-12 sm:py-16 text-center mb-20 shadow-lg">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">
            Mantente Conectado
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-subtle-light dark:text-subtle-dark">
          ...
          <form className="mx-auto mt-8 flex flex-col sm:flex-row max-w-md gap-4 sm:gap-2">
            ...
            <button
              type="submit"
              className="rounded-lg bg-primary px-6 py-3 text-white font-bold text-sm transition hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary"
            >
              Suscribirse
            </button>
          </form>
