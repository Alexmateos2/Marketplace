          ...
          <div className="flex flex-col justify-center flex-1">
            ...
            >
              <span className="truncate">
                {disabled ? "Editar Perfil" : "Cancelar"}
              </span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col">
            ...
            <input
              ...
              readOnly={disabled}
              className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-content-light dark:text-content-dark focus:outline-0 focus:ring-2 focus:ring-primary/50 border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark h-14 p-4 text-base font-normal"
            />
          </div>
          <div className="flex flex-col">
            <label
        ...
        <div className="flex justify-end gap-3 pt-4">
          <button
            ...
            className={
              disabled
                ? "hidden"
                : "flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white dark:bg-primary dark:text-content-dark text-sm font-medium tracking-[0.015em]"
            }
          >
            Guardar Cambios
          </button>
