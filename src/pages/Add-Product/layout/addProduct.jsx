...
const AddProduct = () => {
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark font-display">
      <Navbar />
      <main className="flex-1 px-10 py-12 max-w-4xl mx-auto">
        ...
        <section className="bg-card-light dark:bg-card-dark p-8 rounded-xl shadow-sm border border-border-light dark:border-border-dark">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-lg border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark focus:border-primary focus:ring-primary sm:text-sm"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative mt-1 rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="299.00"
                    className="block w-full rounded-lg border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark focus:border-primary focus:ring-primary pl-7 sm:text-sm"
                  />
                </div>
              </div>
            </div>
              ...
              <div id="specifications-container" className="space-y-4">
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="flex-1 block w-full rounded-lg border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark focus:border-primary focus:ring-primary sm:text-sm"
                  />
                  <input
                    type="text"
