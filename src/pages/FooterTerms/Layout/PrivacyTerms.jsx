            ...
            <div className="prose prose-slate max-w-none prose-h1:text-4xl prose-h1:font-black prose-h2:text-2xl prose-h2:font-bold prose-p:leading-relaxed prose-p:text-slate-600 prose-a:text-content-light dark:text-content-dark hover:prose-a:underline prose-li:text-slate-600 prose-h2:text-slate-900 prose-h1:text-slate-900">
              ...
              <div className="bg-white dark:bg-surface-dark px-8 py-6 rounded-lg shadow-sm">
                <section className="space-y-4 scroll-mt-24" id="introduction">
                  <h2 className="font-bold text-subtle text-lg">
                    Introducción
                  </h2>
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    Bienvenido a Tekia. Estamos comprometidos con la protección
                    de su información personal y su derecho a la privacidad. Si
                    tiene alguna pregunta o inquietud sobre nuestra política o
                    nuestras prácticas con respecto a su información personal,
                    por favor contáctenos. Cuando visita nuestro sitio web y
                    utiliza nuestros servicios, confía en nosotros con su
                    información personal. Nos tomamos muy en serio su
                    privacidad.
                  </p>
                </section>
                <section
                ...
                >
                  ...
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    voluntariamente cuando se registra en el marketplace,
                    expresa interés en obtener información sobre nosotros o
                    nuestros productos y servicios, participa en actividades en
                    el marketplace o nos contacta de cualquier otra manera.
                  </p>
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    identificación personal, datos de cuenta, datos de uso y
                    datos de cookies.
                  </p>
                </section>
                <section className="space-y-4 scroll-mt-24 pt-12" id="info-use">
                  ...
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    Procesamos su información personal para estos fines en base
                    a nuestros intereses comerciales legítimos, para cumplir
                  ...
                  <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>
                      <strong>Gestionar cuentas de usuario.</strong> Podemos
                      usar su información para administrar su cuenta y
                ...
                >
                  ...
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    contratistas o agentes que realizan servicios para nosotros
                    y que requieren acceso a dicha información para realizar su
                    trabajo.
                  </p>
                </section>
                <section
                ...
                >
                  ...
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    apropiadas para proteger la seguridad de cualquier
                    información personal que procesamos. Sin embargo, a pesar de
                    nuestras salvaguardas y esfuerzos para asegurar su
                    información, ninguna transmisión electrónica por Internet o
                    almacenamiento de información puede garantizarse al 100%.
                  </p>
                </section>
                <section
                  className="space-y-4 scroll-mt-24 pt-12"
                ...
                >
                  ...
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    tiene derechos que le permiten mayor acceso y control sobre
                    su información personal. Puede revisar, modificar o cerrar
                    su cuenta en cualquier momento. Estos derechos incluyen el
                ...
                <section className="space-y-4 scroll-mt-24 pt-12" id="cookies">
                  ...
                  <p className="text-content-light/90 dark:text-content-dark/80">
                    ...
                    usamos estas tecnologías y cómo puede rechazar ciertas
                    cookies se detalla en nuestra Política de Cookies.
                  </p>
                </section>
                <section
                  className="space-y-4 scroll-mt-24 pt-12"
            ...
            >
              <h3 className="text-lg font-bold text-text-light-heading">
               ...
               <p className="mt-2 text-base text-text-light-body">
                ...
                <a href="mailto:privacy@tekia.com">privacy@tekia.com</a> o
